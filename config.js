...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~0189247a424d8b679859df63e882c798:357857464e584e68344e413d")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '919564704717-1632403322@g.us',
    ...
    PMB: process.env.PMB || '_Personal messages allowed, BLOCKED!_',
    READ_COMMAND: convertToBool(process.env.READ_COMMAND) || true,
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~0189247a424d8b679859df63e882c798:357857464e584e68344e413d',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "Akash Creation",
    BOT_NAME: process.env.BOT_NAME || 'Akash Creation',
